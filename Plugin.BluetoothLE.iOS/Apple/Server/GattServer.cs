...
{
    public class GattServer : BluetoothLE.Server.AbstractGattServer
    {
        ...
        public override BluetoothLE.Server.IGattService CreateService(Guid uuid, bool primary) => new GattService(this.manager, this, uuid, primary);
        ...
        protected override void RemoveNative(BluetoothLE.Server.IGattService service)
        {
