...
{
    public class GattCharacteristic : BluetoothLE.Server.AbstractGattCharacteristic, IDroidGattCharacteristic
    {
        ...
        readonly IDictionary<string, BluetoothLE.Server.IDevice> subscribers;
                                  ...
                                  GattPermissions permissions) : base(service, uuid, properties, permissions)
        {
            ...
            this.subscribers = new Dictionary<string, BluetoothLE.Server.IDevice>();
        ...
        public override IObservable<BluetoothLE.Server.CharacteristicBroadcast> BroadcastObserve(byte[] value, params BluetoothLE.Server.IDevice[] devices)
        ...
        protected override BluetoothLE.Server.IGattDescriptor CreateNative(Guid uuid, byte[] value)
        {
        ...
        BluetoothLE.Server.IDevice GetOrAdd(BluetoothDevice native)
        {
            lock (this.subscribers)
            {
        ...
        BluetoothLE.Server.IDevice Remove(BluetoothDevice native)
        {
            lock (this.subscribers)
            {
                if (this.subscribers.ContainsKey(native.Address))
