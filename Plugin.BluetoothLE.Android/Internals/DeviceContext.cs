...
namespace Plugin.BluetoothLE.Android.Internals
{
    public class DeviceContext
    {
        ...
        {
            if (!CrossBleAdapterAndroid.AndroidConfiguration.UseInternalSyncQueue)
                return observable;
        ...
        {
            if (this.Gatt == null || !CrossBleAdapterAndroid.AndroidConfiguration.RefreshServices)
                return;
        ...
        {
            if (CrossBleAdapterAndroid.AndroidConfiguration.ShouldInvokeOnMainThread)
        ...
        async void ProcessQueue()
        {
            ...
            {
                this.running = true;
                var ts = CrossBleAdapterAndroid.AndroidConfiguration.PauseBetweenInvocations;
                // TODO: consider
        ...
        void CleanUpQueue()
        {
            ...
            ConcurrentQueueExtensions.Clear<Func<Task>>(this.Actions);
